...
========================================*/
void ConvexHullOperation::ComputeAllFaceParams(const pcl::PointXYZ &oViewPoint,
											   const pcl::PointCloud<pcl::PointNormal> &vPNormals,
											   pcl::PointCloud<pcl::PointXYZ> &vClouds,
											   std::vector<FacePara> &vFaceParams)
{
															  ...
															  const pcl::PointCloud<pcl::PointXYZ> &vCenterPoints)
{
	...
	for (int i = 0; i != vQueryCloud.points.size(); ++i)
	{
		...
		float fOneSignedDis = (vQueryCloud.points[i].x - vCenterPoints[iFaceNum].x) * (vQueryCloud.points[i].x - vCenterPoints[iFaceNum].x) + (vQueryCloud.points[i].y - vCenterPoints[iFaceNum].y) * (vQueryCloud.points[i].y - vCenterPoints[iFaceNum].y) + (vQueryCloud.points[i].z - vCenterPoints[iFaceNum].z) * (vQueryCloud.points[i].z - vCenterPoints[iFaceNum].z);
